...
/**
 * Filter places by game types
 * @param {Array} allPlaces - All available places (already filtered by difficulty from API)
 ...
 */
export function filterPlacesByType(allPlaces, gameTypes) {
...
export class PlaceSelector {
    /**
     * @param {Array} places - Places from API (already filtered by difficulty)
     * @param {Array<string>} gameTypes - Array of game types being played
     */
    constructor(places, gameTypes) {
